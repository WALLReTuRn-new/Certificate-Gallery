...
class Pdf
{
	...
	protected $validOutputFormats = array('jpg', 'jpeg', 'png');
	...
	public function isValidOutputFormat(string $outputFormat)
	{
	...
	public function saveAllPagesAsImages( $directory,  $prefix = '')
	{
		...
		return array_map(function ($pageNumber) use ($directory, $prefix) {
			...
			$destination = "{$directory}/{$prefix}{$pageNumber}.{outputFormat}";
	...
	public function getImageData(string $pathToImage)
	{
		/*
	...
	protected function getRemoteImageData(string $pathToImage)
	{
	...
	protected function determineOutputFormat(string $pathToImage)
	{
